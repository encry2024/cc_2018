<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/transaction*')) }}" href="{{ route('admin.transaction.index') }}"><i class="fa fa-money"></i> {{ __('menus.backend.sidebar.transaction') }}</a>
            </li>
