...
@section('title', app_name() . ' | ' . __('labels.backend.expenses.management'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        {{ __('labels.backend.expenses.management') }} <small class="text-muted">{{ __('labels.backend.expenses.list') }}</small>
                    </h4>
                </div><!--col-->

                <div class="col-sm-7">
                    @include('backend.expense.includes.header-buttons')
                </div><!--col-->
            </div><!--row-->
