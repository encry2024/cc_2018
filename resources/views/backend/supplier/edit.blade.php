...
@section ('title', __('labels.backend.suppliers.management') . ' | ' . __('labels.backend.suppliers.edit'))
...
@section('content')
    {{ html()->modelForm($supplier, 'PATCH', route('admin.supplier.update', $supplier->id))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.suppliers.edit', ['supplier' => $supplier->name]) }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.supplier.name'))->class('col-md-2 label')->for('name') }}
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.supplier.mobile_number'))->class('col-md-2 form-control-label')->for('mobile_number') }}
