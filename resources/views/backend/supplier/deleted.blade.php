...
@section ('title', __('labels.backend.suppliers.management') . ' | ' . __('labels.backend.suppliers.deleted'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.suppliers.deleted') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            @if ($suppliers->count())
                                ...
                                @endforeach
                            @else
                                <tr><td colspan="9"><p class="text-center">{{ __('strings.backend.suppliers.no_deleted') }}</p></td></tr>
                            @endif
                            </tbody>
                        </table>
                    </div>
